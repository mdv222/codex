...
--
-- NAME
-- UFOAD-M2ITIC-DBI1-CH02-HRDBI1-Insert.sql
--
-- DESCRIPTION
...
--
-- USAGE
-- SQL> START UFOAD-M2ITIC-DBI1-CH02-HRDBI1-Insert.sql
--
-- 

SET TERMOUT ON
PROMPT Insert INTO HRDBI1 tables. Please wait.
SET TERMOUT OFF

ALTER SESSION SET NLS_LANGUAGE=American; 
REM ***************************insert data into the Region table
...
ALTER TABLE Department DISABLE CONSTRAINT FK_Dept_Mgr;
...
REM ***************************insert data into the Job table
...
ALTER TABLE Employee DISABLE CONSTRAINT FK_Emp_Mgr;
...
ALTER TABLE Department ENABLE CONSTRAINT FK_Dept_Mgr;
ALTER TABLE Employee ENABLE CONSTRAINT FK_Emp_Mgr;
